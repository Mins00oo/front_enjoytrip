    ...
    <div class="carousel-inner">
            ...
            <div class="col-lg-6 mb-0 d-flex align-items-center">
              <div class="text-align-left align-self-center">
                ...
                <p>
                  ...
                  (beta 1). This template is 100% free provided by
                  <a
                    rel="sponsored"
                    class="text-success"
                  ...
                  >
                  and
                  <a rel="sponsored" class="text-success" href="https://icons8.com/" target="_blank"
                    >Icons 8</a
                  >.
                </p>
              </div>
      ...
      <div class="carousel-item">
        <div class="container">
          <div class="row p-5">
            <div class="mx-auto col-md-8 col-lg-6 order-lg-last">
              <img class="img-fluid" src="src/assets/img/banner_img_02.jpg" alt="" />
            </div>
            <div class="col-lg-6 mb-0 d-flex align-items-center">
              <div class="text-align-left">
                ...
                <p>
                  ...
                  are <strong>not permitted</strong> to re-distribute the template ZIP file in any
      ...
      <div class="carousel-item">
        <div class="container">
          <div class="row p-5">
            <div class="mx-auto col-md-8 col-lg-6 order-lg-last">
              <img class="img-fluid" src="src/assets/img/banner_img_03.jpg" alt="" />
            </div>
            <div class="col-lg-6 mb-0 d-flex align-items-center">
              <div class="text-align-left">
                ...
                <p>
                  ...
                  TemplateMo, please make a small contribution via PayPal or tell your friends about
